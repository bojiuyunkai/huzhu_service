...
func NewSumEndpoint(svc service.AddsvcService, logger log.Logger) endpoint.Endpoint{
	...
	sumEndpoint = mdw.LoggingMiddleware(log.With(logger, "method", method))(sumEndpoint)
	return sumEndpoint;
}
func NewConcatEndpoint(svc service.AddsvcService, logger log.Logger) endpoint.Endpoint{
	...
	concatEndpoint = mdw.LoggingMiddleware(log.With(logger, "method", method))(concatEndpoint)
