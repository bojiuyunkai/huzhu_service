...
import (
	...
	pb "huzhu_service/pb"
	mdw "huzhu_service/pkg/middleware"
)
...
func NewEchoEndpoint(svc service.MsgsvcService, logger log.Logger) endpoint.Endpoint{
	...
	echoEndpoint = mdw.LoggingMiddleware(log.With(logger, "method", method))(echoEndpoint)
	return echoEndpoint;
}
func NewSayHelloEndpoint(svc service.MsgsvcService, logger log.Logger) endpoint.Endpoint{
	...
	sayHelloEndpoint = mdw.LoggingMiddleware(log.With(logger, "method", method))(sayHelloEndpoint)
