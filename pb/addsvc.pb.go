...
// UnimplementedAddsvcServer can be embedded to have forward compatible implementations.
type UnimplementedAddsvcServer struct {
}

func (*UnimplementedAddsvcServer) Sum(ctx context.Context, req *SumRequest) (*SumReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sum not implemented")
}
func (*UnimplementedAddsvcServer) Concat(ctx context.Context, req *ConcatRequest) (*ConcatReply, error) {
